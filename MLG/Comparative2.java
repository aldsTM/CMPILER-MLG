public class Comparative2 extends NonTerminal {
	public Comparative2(String pattern) {
		super("comparative2",pattern);
	}
	...
	public void interpret() throws Exception {
		...
		switch(getProdString()) {
			case "comparative2 OR comparative3":
				nt = (NonTerminal) getComponent("comparative2");
				propagate(nt);
				nt.interpret();
				put("line",nt);

				nt2 = (NonTerminal) getComponent("comparative3");
				propagate(nt2);
				nt2.interpret();
				put("line2",nt2);
				break;
